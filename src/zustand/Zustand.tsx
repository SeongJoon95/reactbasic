...
// - create 함수의 매개변수로 전달된 콜백함수는 ctore객체를 반환해야함
...
const useStore = create<Store>((set) =>({
    ...
    setAddress: (address:string) => set((state) =>(
            // address: address, 값이름이 동일하면 하나로 작성 가능
            // address,
...
export default function Zustand() {
    ...
    return (
        <div style={{padding: '10px', height: '400px', backgroundColor: 'grey'}}>
            {/* <h1>{address}</h1>
...
function Sub1Component1() {
    ...
    return (
        <div style={{ height: '100px', backgroundColor:'brown'}}>
            <h4>안녕</h4>
            <Sub2Component1 />
        </div>
    )
...
function Sub1Component2() {
    ...
    return (
        <div style={{ marginTop: '40px', height: '100px', backgroundColor:'brown'}}>
            <Sub2Component2 />
        </div>
    )
}
...
function Sub2Component1() {
    ...
    return (
        <div style={{ height: '75px', backgroundColor: 'yellowgreen'}}>
