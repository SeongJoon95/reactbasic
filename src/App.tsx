...
// import Component, {ClassComponent,FunctionComponent as F, FunctionComponent,} from "./component/Component";
import "./App.css";
...
// <Route> : URL 패턴에 따라 렌더링 하고자 하는 컴포넌트를 지정하는 컴포넌트
// path 속성 : URL 패턴을 지정
...
function Layout() {
  ...
  // <Outlet> : 부모 <Route>에 해당하는 컴포넌트가 element로 등록되었을때
    ...
    <Routes>
      <Route index element={<h1>기본 페이지</h1>} />
        ...
        <Route path="/component_manage">
          <Route path="ListRender2" element={<ListRender />} />
